...
def generateFacts(facts_type):
    chat, system = gpt_utils.load_yaml_prompt('prompt_templates/facts_generator.yaml')
...
def generateFactSubjects(n):
    out = []
    chat, system = gpt_utils.load_yaml_prompt('prompt_templates/facts_subjects_generation.yaml')
